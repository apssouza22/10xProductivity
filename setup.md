...
> Generated by [auto-pilot-agent](https://github.com/apssouza22/auto-pilot-agent). To connect new tools or add integrations, see that repo.

Repo: `/absolute/path/to/auto-pilot-agent`
