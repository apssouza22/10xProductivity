...
- Contextual-task follow-up submission should be treated as unverified unless a
  fresh live run captures scrubbed evidence for that path. Use the normal AI
  Mode search-page path for documented multi-turn follow-ups.
